quotations = [
    ...
    or offer your own version in return. - Salman Rushdie",
    ...
    stay alive by hiding between the covers of a book. - E.B. White",

    "A book is a garden, an orchard, a storehouse, a party, a company by the way, a counselor,\
    a multitude of counselors.- Charles Baudelaire",

    "There is more treasure in books than in all the pirate’s loot on Treasure Island. - Walt Disney",

    "A great book should leave you with many experiences, and slightly exhausted at the end. You live several lives while reading. - William StyronThe",

    "America I love still exists at the front desks of our public libraries. - Kurt Vonnegut",
