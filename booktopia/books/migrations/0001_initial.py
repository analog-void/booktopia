    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, upload_to='editions_images/', verbose_name='Лого')),
                ('stars', models.PositiveSmallIntegerField(default=5, null=True, verbose_name='Звезди')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rent_status', models.CharField(blank=True, choices=[('PENDING', 'ПЛАНИРАНА'), ('EFFECTIVE', 'ТЕКУЩА'), ('TERMINATED', 'ПРИКЛЮЧИЛА'), ('UNATTRACTIVE', 'БЕЗ ПРОДЪЛЖЕНИЕ')], default='NULL', max_length=12, null=True)),
